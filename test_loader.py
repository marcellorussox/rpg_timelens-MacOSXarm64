...
if __name__ == "__main__":
    ...
    event_file = join(args.dataset_root,
                      "%s/test/%s/events_aligned/%06d.npz" % (args.dataset_type, args.sequence, args.sample_index))
    image_file = join(args.dataset_root,
                      "%s/test/%s/images_corrected/%06d.png" % (args.dataset_type, args.sequence, args.sample_index))
